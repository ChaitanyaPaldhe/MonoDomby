...
exports.canManageProperties = canManageProperties;
 ...
 */
function canManageProperties(state) {
    ...
    if (state.turn.pendingDecision !== null && state.turn.pendingDecision.type !== shared_1.DecisionType.DEBT_RECOVERY) {
        return false;
    }
