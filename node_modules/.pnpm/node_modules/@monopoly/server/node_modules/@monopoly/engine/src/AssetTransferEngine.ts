...
import { GameState, PlayerId, TileId, EventType } from '@monopoly/shared';;
  ...
  public static transferAllAssets(
    ...
    if (goojfCards > 0) {
      ...
      if (toPlayerId !== null) {
        ...
        // Return to bank (deck)
        const chanceDiscard = [...currentState.cardDecks.chanceDiscard];
        const ccDiscard = [...currentState.cardDecks.communityChestDiscard];
        ...
        const chanceDeck = [...currentState.cardDecks.chance];
