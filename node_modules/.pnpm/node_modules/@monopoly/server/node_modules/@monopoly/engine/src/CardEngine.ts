...
import type { MapConfig, CardConfig } from '@monopoly/maps';
import type { GameState, PlayerId, RNGState, CardDeckState, ClientAction, CardAppliedEvent } from '@monopoly/shared';;
