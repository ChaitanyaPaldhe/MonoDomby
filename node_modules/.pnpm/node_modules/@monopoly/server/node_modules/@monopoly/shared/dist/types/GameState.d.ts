import type { GamePhase, TurnPhase, AuctionStatus, TradeStatus, WinCondition, DisconnectedPlayerPolicy, JailReason, DecisionType, CardDeckType } from './Enums.js';
...
export declare const PlayerId: (id: string) => PlayerId;
export declare const TileId: (id: string) => TileId;
export declare const TradeId: (id: string) => TradeId;
export declare const AuctionId: (id: string) => AuctionId;
export declare const RoomId: (id: string) => RoomId;
export declare const GameId: (id: string) => GameId;
/**
