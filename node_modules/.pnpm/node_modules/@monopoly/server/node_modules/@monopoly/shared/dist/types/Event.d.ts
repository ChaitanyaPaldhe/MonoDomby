import type { PlayerId, TileId, TradeId, AuctionId, TradeOffer, AuctionState, TradeState } from './GameState.js';
import type { JailReason, JailReleaseMethod, CardDeckType } from './Enums.js';
...
export type Audience = {
    ...
    readonly type: 'PLAYERS_EXCEPT';
    readonly excludePlayerIds: readonly PlayerId[];
};
 ...
 */
export type ExtractEvent<T extends EventType> = Extract<GameEvent, {
    type: T;
}>;
/**
