...
class TradeEngine {
    ...
    proposeTrade(state, initiatorId, targetId, offer, request, mapConfig, now) {
        // TODO: Implement
        throw new errors_js_1.EngineNotImplementedError('TradeEngine.proposeTrade');
    }
    // -------------------------------------------------------------------------
    // Counter
    // -------------------------------------------------------------------------
    ...
    counterTrade(state, playerId, tradeId, newOffer, newRequest, mapConfig, now) {
        // TODO: Implement
        throw new errors_js_1.EngineNotImplementedError('TradeEngine.counterTrade');
    }
    // -------------------------------------------------------------------------
    // Accept
    // -------------------------------------------------------------------------
    ...
    acceptTrade(state, playerId, tradeId, mapConfig, now) {
        // TODO: Implement
        throw new errors_js_1.EngineNotImplementedError('TradeEngine.acceptTrade');
    }
    // -------------------------------------------------------------------------
    // Reject
    // -------------------------------------------------------------------------
    ...
    rejectTrade(state, playerId, tradeId, now) {
        // TODO: Implement
        throw new errors_js_1.EngineNotImplementedError('TradeEngine.rejectTrade');
    }
    // -------------------------------------------------------------------------
    // Cancel
    // -------------------------------------------------------------------------
    ...
    cancelTrade(state, playerId, tradeId, now) {
        // TODO: Implement
        throw new errors_js_1.EngineNotImplementedError('TradeEngine.cancelTrade');
    }
    // -------------------------------------------------------------------------
    // Expiry Cleanup
    // -------------------------------------------------------------------------
    ...
    expireOldTrades(state, now) {
        // TODO: Implement
        throw new errors_js_1.EngineNotImplementedError('TradeEngine.expireOldTrades');
    }
    // -------------------------------------------------------------------------
    ...
    executeTrade(state, trade) {
        // TODO: Implement
        throw new errors_js_1.EngineNotImplementedError('TradeEngine.executeTrade');
    }
    // -------------------------------------------------------------------------
    // Helpers
    // -------------------------------------------------------------------------
    ...
    requireTrade(state, tradeId) {
        ...
        if (!trade) {
            throw new errors_js_1.EngineValidationError(`Trade '${tradeId}' not found.`, shared_1.ErrorCode.E_TRADE_NOT_FOUND);
        }
        return trade;
    }
    /**
    ...
    assertNotExpired(trade, now) {
        if (now >= trade.expiresAt) {
            throw new errors_js_1.EngineValidationError(`Trade '${trade.id}' has expired.`, shared_1.ErrorCode.E_TRADE_EXPIRED);
        }
    }
}
