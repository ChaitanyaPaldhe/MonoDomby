import { GameState, MapConfig, PlayerId, TileId, DecisionType, ErrorCode } from '@monopoly/shared';
...
export class BankruptcyPlanner {
  public static planBankruptcy(
    ...
    for (const tId of player.properties) {
      ...
      if (tile?.houses && tile.houses > 0) hasBuildings = true;
      if (tile?.hasHotel) hasBuildings = true;
