...
// Not exported to the client. Import from this file within the engine only.
// =============================================================================
...
export type ValidationResult =
  | { readonly valid: true }
  | { readonly valid: false; readonly reason: string; readonly code: ErrorCode };

// ---------------------------------------------------------------------------
// Validator & Handler Function Types
// ---------------------------------------------------------------------------
...
export interface MortgagePlan {
  readonly tileId: TileId;
  readonly isMortgaging: boolean; // true if mortgaging, false if unmortgaging
  readonly playerMoneyChange: number;
  readonly events: readonly GameEvent[];
}
