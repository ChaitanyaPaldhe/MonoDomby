...
import { PropertyManagementEngine } from '../../src/engine/PropertyManagementEngine.js';
import { GameState, MapConfig, GamePhase, TurnPhase, ErrorCode, EventType } from '@monopoly/shared';
...
describe('PropertyTransactionPlanner & PropertyManagementEngine', () => {
  ...
  describe('planBuildHouse', () => {
    ...
    it('rejects building if it violates even-building rule', () => {
      ...
      let plan = PropertyTransactionPlanner.planBuildHouse(mockState, mockMapConfig, 't1', 'p1', 'action1', 0);
      let { newState } = PropertyManagementEngine.applyTransaction(mockState, plan, mockMapConfig, 'p1');
    ...
    it('allows building second house if group is even', () => {
      ...
      let { newState: state2 } = PropertyManagementEngine.applyTransaction(newState, plan, mockMapConfig, 'p1');
