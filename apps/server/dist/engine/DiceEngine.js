 ...
 * @internal
 */
function xoshiro256ppNext(s0, s1, s2, s3) {
...
class DiceEngine {
     ...
     */
    static createRNGState(seed, gameId) {
     ...
     * @internal
     */
    static rollOneDie(rngState, faces = DiceEngine.FACES) {
        const [output, ns0, ns1, ns2, ns3] = xoshiro256ppNext(rngState.s0, rngState.s1, rngState.s2, rngState.s3);
...
//# sourceMappingURL=DiceEngine.js.map