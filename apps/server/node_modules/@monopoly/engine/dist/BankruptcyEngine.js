import { TurnPhase, EventType } from '@monopoly/shared';
;
...
export class BankruptcyEngine {
    static executeBankruptcyPlan(state, plan, config, actionId, clientTs) {
        ...
        const transferResult = AssetTransferEngine.transferAllAssets(currentState, playerId, plan.creditorId, actionId, clientTs, config);
