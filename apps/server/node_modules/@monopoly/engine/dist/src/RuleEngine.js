...
class RuleEngine {
     ...
     */
    register(id, handler, priority = 100) {
     ...
     */
    applyAll(state, context) {
        return this.rules.reduce((currentState, rule) => {
     ...
     */
    applyByPrefix(state, context, prefix) {
        return this.rules
     ...
     */
    static RULE_PASS_GO = 'core/pass-go';
    /**
