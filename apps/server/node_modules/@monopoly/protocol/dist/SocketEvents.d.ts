...
import type { GameState, AuctionState, TradeState, PlayerId, RoomId, GameSettings } from '@monopoly/shared';
...
export interface ClientToServerEvents {
    'CLIENT:AUTHENTICATE': (payload: {
        token: string;
    }, ack: (success: boolean) => void) => void;
    'CLIENT:JOIN_ROOM': (payload: {
        roomId: RoomId;
        displayName: string;
        tokenId: string;
    }) => void;
    'CLIENT:LEAVE_ROOM': (payload: {
        roomId: RoomId;
    }) => void;
    'CLIENT:SPECTATE_ROOM': (payload: {
        roomId: RoomId;
    }) => void;
    ...
    'CLIENT:REQUEST_FULL_STATE': (payload: {
        roomId: RoomId;
    }) => void;
...
export interface ServerToClientEvents {
    ...
    'ROOM:PLAYER_READY': (payload: {
        playerId: PlayerId;
    }) => void;
    'ROOM:SETTINGS_UPDATED': (payload: {
        settings: GameSettings;
    }) => void;
    'ROOM:HOST_MIGRATED': (payload: {
        newHostId: PlayerId;
        previousHostId: PlayerId;
    }) => void;
    'ROOM:GAME_STARTING': (payload: {
        countdown: number;
    }) => void;
    ...
    'TRADE:ACCEPTED': (payload: {
        tradeId: string;
    }) => void;
    'TRADE:REJECTED': (payload: {
        tradeId: string;
    }) => void;
    'TRADE:CANCELLED': (payload: {
        tradeId: string;
    }) => void;
...
export interface InterServerEvents {
    'SERVER:ROOM_STATE_CHANGED': (payload: {
        roomId: RoomId;
        version: number;
    }) => void;
}
