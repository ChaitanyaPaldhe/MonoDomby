...
export class BankruptcyEngine {
  ...
  canSatisfyDebt(
    ...
    debtAmount: number,
    mapConfig: MapConfig,
  ): { canSatisfy: boolean; maxRaisable: number } {
    // TODO: Implement
    throw new EngineNotImplementedError('BankruptcyEngine.canSatisfyDebt');
  }
  ...
  declareBankruptcy(
    ...
    // TODO: Implement
    throw new EngineNotImplementedError('BankruptcyEngine.declareBankruptcy');
  }
   ...
   */
  liquidateAllBuildings(
    state: GameState,
    playerId: PlayerId,
    mapConfig: MapConfig,
  ): [GameState, number] {
    // TODO: Implement
    throw new EngineNotImplementedError('BankruptcyEngine.liquidateAllBuildings');
  }
  ...
  transferProperty(
    ...
    // TODO: Implement
    throw new EngineNotImplementedError('BankruptcyEngine.transferProperty');
  }
  ...
  private computeMaxRaisable(
    ...
    // TODO: Implement
    throw new EngineNotImplementedError('BankruptcyEngine.computeMaxRaisable');
  }
}
